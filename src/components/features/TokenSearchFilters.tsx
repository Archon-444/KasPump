    ...
    <div className={cn('space-y-4', className)}>
      ...
      <div className="relative">
        ...
        <Input
          ...
          className="pl-10 pr-10 h-10 text-sm bg-white/[0.03] border-white/[0.06]"
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="flex items-center gap-1.5">
          <select
            ...
            className="bg-white/[0.03] border border-white/[0.06] rounded-lg px-2.5 py-1.5 text-xs text-gray-300 focus:ring-yellow-500/30 focus:border-yellow-500/30 appearance-none cursor-pointer"
          >
          ...
          <button
            ...
            className={cn(
              ...
              'hover:bg-white/[0.04] text-gray-500 hover:text-gray-300',
        ...
        <button
          ...
          className={cn(
            ...
            showAdvancedFilters
              ...
              : 'bg-white/[0.03] hover:bg-white/[0.06] text-gray-400 border border-white/[0.06]'
          )}
        >
          <Filter size={12} />
          <span>Filters</span>
          {hasActiveFilters && (
            <span className="px-1 py-0 bg-yellow-500 text-[9px] font-bold text-gray-900 rounded">
              {[
